...
public class SingleLinkedList {
	//public static SingleLinkedListTest crunchifyList;

	public static void main(String[] args) {

		SingleLinkedListTest crunchifyList;
		// Default constructor - let's put "0" into head element.
		crunchifyList = new SingleLinkedListTest();
...
// }//class Node
//	
// //My solution (probably no real modification of the list, modifying aux, returns the tail of the list)
// public Node eraseDuplicates(Node tail){	 
//	 //Case zero or one element (no duplicates)
//	 if(tail==null||tail.next==null)
//		 return tail;	 
//	 Node aux=tail;
//	 
//	 HashMap<Integer,Node> hmBuffer=new HashMap<Integer,Node>();
//	 hmBuffer.put(Integer.valueOf(aux.elem), aux);	 	 
//	 while (aux.next!=null){
//		 	//hmBuffer.put(aux.next.elem, aux.next);//buffer the next element
//		 if (!hmBuffer.containsKey(Integer.valueOf(aux.next.elem)))
//			 hmBuffer.put(aux.next.elem, aux);
//		 else
//			 aux.next=aux.next.next;
//		 aux=aux.next;		 
//	 }
//		 return tail;	 
// }//eraseDuplicates procedure
// 
// //Book solution (this solution modify directly the list (no aux), no return to the head, just do what is asked for)
